...
return [
    ...
    */
    'attributes'           => [
        ...
        'canonical'             => 'آدرس کاننیکال',
        'old_url'               => 'آدرس قدیمی',
        'redirect_to'           => 'آدرس ریدایرکت',
        'robots_meta'           => 'متا ربات',
        'tag'                   => 'تگ',
        'tags'                  => 'تگ ها',
        'ordering'              => 'ترتیب',
        'link'                  => 'لینک',
        'position'              => 'موقعیت',
        'timer_start'           => 'تایمر شروع',
        'expired_at'            => 'تاریخ انقضا',
        'has_timer'             => 'دارای تایمر',
        'published'             => 'وضعیت انتشار',
        'published_at'          => 'تاریخ انتشار',
        'favorite'              => 'علاقمندی',
        'favorite_faq'          => 'سوال برگزیده',
        'category'              => 'دسته بندی',
        'mobile'                => 'شماره موبایل',
        'role'                  => 'نقش',
        'type'                  => 'نوع',
        ...
        'comment'               => 'نظر',
        'admin_note'            => 'پاسخ ادمین',
        'admin_name'            => 'نام ادمین',
        'company_name'          => 'نام شرکت',
        'comment_for'           => 'نظر برای',
        'size'                  => 'اندازه',
        'bio'                   => 'بیوگرافی',
        'birthday'              => 'تاریخ تولد',
        'image'                 => 'تصویر',
