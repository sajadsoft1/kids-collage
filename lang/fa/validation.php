...
return [
    ...
    */
    ...
    'file_upload_expired' => 'یک یا چند فایل آپلود شده دیگر در دسترس نیستند. لطفاً دوباره آپلود کنید.',
    ...
    */
    'attributes' => [
        ...
        'twitter_image' => 'تصویر Twitter Card',
        'focus_keyword' => 'کلمه کلیدی اصلی',
        'meta_keywords' => 'کلمات کلیدی متا',
        'author' => 'نویسنده',
        'sitemap_exclude' => 'حذف از Sitemap',
        'sitemap_priority' => 'اولویت Sitemap',
        'sitemap_changefreq' => 'فرکانس تغییر Sitemap',
        ...
        'session_id' => 'جلسه',
        'course_session_id' => 'جلسه',
        'excuse_note' => 'شرح عدم حضور',
        'present' => 'حضور',
        ...
        'shuffle_questions' => 'نمایش تصادفی سوالات',
        'show_results' => 'نمایش نتایج',
        'allow_review' => 'اجازه بازبینی',
        'duration' => 'مدت زمان',
        'starts_at' => 'زمان شروع',
        'ends_at' => 'زمان پایان',
        'course_id' => 'دوره',
        'enroll_date' => 'تاریخ ثبت نام',
        'amount' => 'مبلغ',
        ...
        'gender' => 'جنسیت',
        'address' => 'آدرس',
        'phone' => 'شماره منزل/محل کار',
        'father_name' => 'نام پدر',
        'father_phone' => 'شماره موبایل پدر',
        'father_age' => 'سن پدر',
        'father_education' => 'مدرک تحصیلی پدر',
        'father_workplace' => 'محل کار پدر',
        'mother_name' => 'نام مادر',
        'mother_phone' => 'شماره موبایل مادر',
        'mother_age' => 'سن مادر',
        ...
        'unlimited' => 'بدون حد',
        'biography' => 'بیوگرافی',
        'sickness' => 'مشکلات سلامتی',
        'delivery_recipient' => 'اطلاعات تحویل گیرنده',
    ],
];
