...
Route::group(['prefix' => 'bulletin', 'as' => 'bulletin.'], function () {
    ...
    Route::post('{bulletin:slug}/comment', [BulletinController::class, 'storeUserComment'])->name('store-user-comment');
    ...
    Route::get('tag/{tag}', [BulletinController::class, 'indexByTag'])->name('by-tag');
