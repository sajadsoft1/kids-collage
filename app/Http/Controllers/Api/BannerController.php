...
class BannerController extends Controller
{
    ...
    {
        return QueryBuilder::for(Banner::query())
     ...
     *     @OA\Parameter(name="filter[size]", required=false, in="query", @OA\Schema(type="string", enum={"1x1", "6x9", "4x3"}), description="Filter by size"),
    ...
    public function index(Request $request): JsonResponse
    {
        return Response::dataWithAdditional(
            ...
            ])->paginate($request->input('page_limit', 1))->toResourceCollection(BannerResource::class),
            [
                'sort' => [
     ...
     *     @OA\Parameter(name="banner", required=true, in="path", @OA\Schema(type="string")),
     *     @OA\Response(response=200,
     *         description="Successful operation",
     *         @OA\JsonContent(type="object",
     *             @OA\Property(property="message", type="string", default="No message"),
