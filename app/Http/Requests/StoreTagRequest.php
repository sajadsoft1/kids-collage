 ...
 *     type="object",
 *     required={"name", "seo_title", "seo_description", "robots_meta","slug","type"},
 *
 ...
 *     @OA\Property(property="type", type="string", enum={"special"}, default="special", description="Tag type"),
 ...
 *     @OA\Property(property="old_url", type="string", description="Old URL for redirect", default=""),
 *     @OA\Property(property="redirect_to", type="string", description="Redirect target URL", default=""),
