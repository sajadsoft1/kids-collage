 ...
 *     @OA\Property(property="children", type="array", @OA\Items(ref="#/components/schemas/SimpleCategoryResource")),
...
class CategoryDetailResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return array_merge($resource, [
            ...
            'children'   => $this->whenLoaded('children', fn () => SimpleCategoryResource::collection($this->children)),
