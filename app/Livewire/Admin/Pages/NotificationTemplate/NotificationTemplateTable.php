...
final class NotificationTemplateTable extends PowerGridComponent
{
    ...
    public function breadcrumbs(): array
    {
        return [
            ...
            ['label' => trans('general.page.index.title', ['model' => trans('notificationTemplate.model')])],
        ];
    }
    ...
    {
        return [
            ['link' => route('admin.notificationTemplate.create'), 'icon' => 's-plus', 'label' => trans('general.page.create.title', ['model' => trans('notificationTemplate.model')])],
        ];
    }
    ...
    public function noDataLabel(): string|View
    {
        return view('admin.datatable-shared.empty-table',[
            'link'=>route('admin.notificationTemplate.create')
        ]);
    }
