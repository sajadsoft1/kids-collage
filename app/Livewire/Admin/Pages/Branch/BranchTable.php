...
final class BranchTable extends PowerGridComponent
{
    ...
    public string $tableName = 'index_branch_datatable';
    ...
    public function breadcrumbs(): array
    {
        return [
            ...
            ['label' => trans('general.page.index.title', ['model' => trans('branch.model')])],
        ];
    }
    ...
    {
        return [
            ['link' => route('admin.branch.create'), 'icon' => 's-plus', 'label' => trans('general.page.create.title', ['model' => trans('branch.model')])],
        ];
    }
    ...
    public function noDataLabel(): string|View
    {
        return view('admin.datatable-shared.empty-table', [
            'link' => route('admin.branch.create'),
        ]);
    }
}
