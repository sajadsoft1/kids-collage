...
final class NewsTable extends PowerGridComponent
{
    ...
    public string $tableName = 'index_news_datatable';
    ...
    public function breadcrumbs(): array
    {
        return [
            ...
            ['label' => trans('general.page.index.title', ['model' => trans('news.model')])],
        ];
    }
    ...
    {
        return [
            ['link' => route('admin.news.create'), 'icon' => 's-plus', 'label' => trans('general.page.create.title', ['model' => trans('news.model')])],
        ];
    }
