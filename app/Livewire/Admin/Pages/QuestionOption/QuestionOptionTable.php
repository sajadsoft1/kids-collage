...
final class QuestionOptionTable extends PowerGridComponent
{
    ...
    public function breadcrumbs(): array
    {
        return [
            ...
            ['label' => trans('general.page.index.title', ['model' => trans('questionOption.model')])],
        ];
    }
    ...
    {
        return [
            ['link' => route('admin.question-option.create'), 'icon' => 's-plus', 'label' => trans('general.page.create.title', ['model' => trans('questionOption.model')])],
        ];
    }
    ...
    public function actions(QuestionOption $row): array
    {
        return [
    ...
    public function noDataLabel(): string|View
    {
        return view('admin.datatable-shared.empty-table', [
            'link' => route('admin.question-option.create'),
        ]);
    }
}
