    ...
    public function breadcrumbsActions(): array
    {
        return [
            [
                ...
                'access' => auth()->user()->hasAnyPermission(PermissionsService::generatePermissionsByModel(Blog::class, 'Store')),
            ],
        ];
    }
    ...
    public function filters(): array
    {
        return [
            ...
            Filter::select('category_formatted', 'category_id')
                ->dataSource(Category::where('type', CategoryTypeEnum::BLOG->value)->get()->map(function ($category) {
                    return [
                        'value' => $category->id,
