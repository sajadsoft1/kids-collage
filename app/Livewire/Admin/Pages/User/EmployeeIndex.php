...
final class EmployeeIndex extends PowerGridComponent
{
    ...
    {
        return User::query()->whereNotIn('type', [UserTypeEnum::USER, UserTypeEnum::PARENT]);
    }
    ...
    public function filters(): array
    {
        return [
            ...
            Filter::enumSelect('type', 'type')
                ->datasource(UserTypeEnum::employeeOptions()),
        ];
    }
