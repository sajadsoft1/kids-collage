...
namespace App\Livewire\Admin\Pages\CourseTemplateLevel;

use App\Actions\CourseTemplateLevel\StoreCourseTemplateLevelAction;
use App\Actions\CourseTemplateLevel\UpdateCourseTemplateLevelAction;
...
final class CourseTemplateLevelTable extends PowerGridComponent
{
    use HasModalForm;
    use PowerGridHelperTrait;
    use Toast;

    public string $tableName = 'index_courseTemplateLevel_datatable';
    ...
    {
        return CourseTemplateLevel::class;
    }

    protected function getStoreActionClass(): string
    {
        return StoreCourseTemplateLevelAction::class;
    }

    protected function getUpdateActionClass(): string
    {
        return UpdateCourseTemplateLevelAction::class;
    }

    protected function getModelTranslationKey(): string
    {
        return 'courseTemplateLevel.model';
    }
    ...
    public function breadcrumbs(): array
    {
        return [
            ...
            ['label' => trans('general.page.index.title', ['model' => trans('courseTemplateLevel.model')])],
        ];
    }
    ...
    {
        return [
            ['action' => 'openCreateModal', 'icon' => 's-plus', 'label' => trans('general.page.create.title', ['model' => trans('courseTemplateLevel.model')])],
        ];
    }
    ...
    public function actions(CourseTemplateLevel $row): array
    {
        return [
    ...
    public function noDataLabel(): string|View
    {
        return view('admin.datatable-shared.empty-table', [
            'link' => route('admin.course-template-level.index'),
        ]);
    }
}
