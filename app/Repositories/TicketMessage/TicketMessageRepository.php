...
class TicketMessageRepository extends BaseRepository implements SelectableContract, TicketMessageRepositoryInterface
{
    ...
    {
        return QueryBuilder::for(TicketMessage::query())
    ...
    public function select(array $payload = []): Collection
    {
        ...
        if ( ! empty($payload['selected'])) {
            ...
            $selectedQuery = TicketMessage::whereIn('id', $selected);
