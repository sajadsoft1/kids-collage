...
class TagRepository extends BaseRepository implements SelectableContract, TagRepositoryInterface
{
    ...
    {
        return QueryBuilder::for(Tag::query())
    ...
    public function select(array $payload = []): Collection
    {
        ...
        if ( ! empty($payload['selected'])) {
            ...
            $selectedQuery = Tag::whereIn('id', $selected);
