...
class ContactUsRepository extends BaseRepository implements ContactUsRepositoryInterface,SelectableContract
{
    ...
    public function select(array $payload = []): Collection
    {
        ...
        if ( ! empty($payload['selected'])) {
            ...
            $selectedQuery = ContactUs::whereIn('id', $selected);
