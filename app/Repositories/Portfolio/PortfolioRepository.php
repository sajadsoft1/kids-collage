...
class PortfolioRepository extends BaseRepository implements PortfolioRepositoryInterface, SelectableContract
{
    ...
    {
        // Default relationships for Portfolio
        $defaultRelations = ['category', 'creator'];
    ...
    public function select(array $payload = []): Collection
    {
        ...
        if ( ! empty($payload['selected'])) {
            ...
            $selectedQuery = Portfolio::whereIn('id', $selected);
