...
class BranchRepository extends BaseRepository implements BranchRepositoryInterface,SelectableContract
{
    ...
    {
        return QueryBuilder::for(Branch::query())
    ...
    public function select(array $payload = []): Collection
    {
        ...
        if ( ! empty($payload['selected'])) {
            ...
            $selectedQuery = Branch::whereIn('id', $selected);
