...
class CardFlowRepository extends BaseRepository implements CardFlowRepositoryInterface,SelectableContract
{
    public function __construct(CardFlow $model)
    {
    ...
    {
        return QueryBuilder::for(CardFlow::query())
    ...
    public function select(array $payload = []): Collection
    {
        ...
        if ( ! empty($payload['selected'])) {
            ...
            $selectedQuery = CardFlow::whereIn('id', $selected);
