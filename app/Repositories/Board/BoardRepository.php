...
class BoardRepository extends BaseRepository implements BoardRepositoryInterface,SelectableContract
{
    ...
    {
        return QueryBuilder::for(Board::query())
    ...
    public function select(array $payload = []): Collection
    {
        ...
        if ( ! empty($payload['selected'])) {
            ...
            $selectedQuery = Board::whereIn('id', $selected);
