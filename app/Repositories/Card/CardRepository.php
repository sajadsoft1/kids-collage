...
class CardRepository extends BaseRepository implements CardRepositoryInterface,SelectableContract
{
    ...
    {
        return QueryBuilder::for(Card::query())
    ...
    public function select(array $payload = []): Collection
    {
        ...
        if ( ! empty($payload['selected'])) {
            ...
            $selectedQuery = Card::whereIn('id', $selected);
