...
class NewsRepository extends BaseRepository implements NewsRepositoryInterface,SelectableContract
{
    ...
    {
        return QueryBuilder::for(News::query())
    ...
    public function select(array $payload = []): Collection
    {
        ...
        if ( ! empty($payload['selected'])) {
            ...
            $selectedQuery = News::whereIn('id', $selected);
