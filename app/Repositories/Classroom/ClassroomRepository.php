...
class ClassroomRepository extends BaseRepository implements ClassroomRepositoryInterface,SelectableContract
{
    ...
    {
        return QueryBuilder::for(Classroom::query())
    ...
    public function select(array $payload = []): Collection
    {
        ...
        if ( ! empty($payload['selected'])) {
            ...
            $selectedQuery = Classroom::whereIn('id', $selected);
