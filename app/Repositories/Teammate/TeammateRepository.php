...
class TeammateRepository extends BaseRepository implements TeammateRepositoryInterface,SelectableContract
{
    public function __construct(Teammate $model)
    {
    ...
    {
        return QueryBuilder::for(Teammate::query())
    ...
    public function select(array $payload = []): Collection
    {
        ...
        if ( ! empty($payload['selected'])) {
            ...
            $selectedQuery = Teammate::whereIn('id', $selected);
