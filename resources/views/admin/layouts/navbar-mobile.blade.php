<div x-show="!isDesktop && open" class="relative z-50 lg:hidden"
    ...
    <div x-show="!isDesktop && open" x-transition:enter="transition-opacity ease-linear duration-300"
        ...
        x-transition:leave-end="opacity-0" class="fixed left-0 right-0 bg-gray-900/80"
        x-description="Off-canvas menu backdrop, show/hide based on off-canvas menu state." aria-hidden="true">

    </div>


    <div class="fixed left-0 right-0 flex">
