@php
    ...
    $description = __('error.429.description');
...
<x-layouts.error>
    <div class="card bg-base-100 shadow-xl">
        <div class="card-body items-center text-center">
            {{-- Error Icon --}}
            <div class="mb-4">
                <i class="fas fa-tachometer-alt text-6xl text-warning"></i>
            </div>

            {{-- Error Code --}}
            <h1 class="text-8xl font-bold text-warning mb-4">429</h1>
            ...
            <div class="card-actions justify-center gap-4 flex-wrap">
                <button onclick="setTimeout(() => window.location.reload(), 3000)" class="btn btn-primary">
