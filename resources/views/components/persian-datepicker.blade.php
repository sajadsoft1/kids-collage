    ...
    <div class="relative" x-data="persianDatepicker('{{ $uniqueId }}', '{{ $defaultDate }}', '{{ $setNullInput }}', '{{ $withTime }}', '{{ $showFormat }}', '{{ $returnFormat }}', '{{ $currentView }}', '{{ $minDate }}', '{{ $maxDate }}')" x-init="[initDate(), getNoOfDays()]" id="{{ $uniqueId }}" x-cloak>
        <div class="relative pdp-input-area">
            ...
            <div class="relative flex items-center mt-1">
                ...
                <span x-show="datepickerValue" class="material-icons cursor-pointer absolute left-9 remove_date"
        ...
        <div class="bg-white z-40 rounded-lg shadow p-4 absolute left-0" style="width: 17rem"
            ...
            <div class="flex justify-between items-center mb-2">
                <div>
                    ...
                    <span x-text="year" @click="currentView = 'year'"
                        class="ml-1 text-lg text-gray-600 font-normal cursor-pointer"></span>
                </div>
                <div>
                    <button type="button"
        ...
        <div class="relative pdp-time-area mt-2 flex flex-row-reverse items-center gap-1"
