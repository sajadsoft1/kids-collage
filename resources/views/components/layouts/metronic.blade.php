...
<body class="bg-gray-50" x-data>
    ...
    <x-main full-width class="min-h-screen" active-bg-color="">
        ...
        <x-slot:sidebar drawer="main-drawer" collapsible
            class="no-scrollbar bg-white border-e border-gray-200 shadow-lg">
            ...
            <div class="sticky top-0 bg-white p-6 z-10 border-b border-gray-200">
                <div class="hidden-when-collapsed">
                    <div class="flex items-center gap-3 mb-2">
                        ...
                        <div>
                            <h1 class="text-xl font-bold text-gray-900">Karnoweb</h1>
                ...
                <div class="display-when-collapsed hidden text-center">
                    <div
                        class="w-8 h-8 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg flex items-center justify-center mx-auto">
                        <x-icon name="o-cube" class="w-5 h-5 text-white" />
                    </div>
                </div>
            </div>
        ...
        <x-slot:content class="!pt-0">
            {{-- Top Header Bar --}}
            <div class="sticky top-0 z-40 bg-white border-b border-gray-200 px-6 py-4 shadow-sm">
