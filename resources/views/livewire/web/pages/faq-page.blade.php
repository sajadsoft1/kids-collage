            ...
            <div class="flex flex-wrap mx-[-15px] !mt-[-50px] xl:mx-[-35px] lg:mx-[-20px] items-center">
                <div
                    ...
                    <figure class="m-0 p-0 relative">
                        ...
                        <img class="w-auto relative z-10" src="/assets/img/illustrations/i22.png"
                            alt="{{ trans('web/faq.hero_section.tag') }}">
                    </figure>
                </div>
                <div
                    class="xl:w-5/12 lg:w-5/12 w-full flex-[0_0_auto] xl:!px-[35px] lg:!px-[20px] !px-[15px] max-w-full !mt-[50px]">
                    <span
                        class="bg-[#fef4f2] text-[#f78b77] px-4 py-2 rounded-full text-sm font-medium inline-block mb-4">{{ trans('web/faq.hero_section.tag') }}</span>
            ...
            <div class="flex flex-wrap mx-[-15px] xl:mx-[-35px] lg:mx-[-20px] !mt-[-50px]">
                <div class="w-full flex-[0_0_auto] xl:!px-[35px] lg:!px-[20px] !px-[15px] max-w-full !mt-[50px]">
                    <div class="accordion accordion-wrapper" id="accordionSimple">
                        {{-- سوال 1 --}}
                        <div
                            class="card accordion-item bg-white hover:bg-gray-50 rounded-2xl shadow-sm mb-4 transition-all duration-300 hover:-translate-y-1">
                            <div class="card-header border-b border-gray-100" id="headingOne">
                                <button
                                    class="accordion-button collapsed w-full text-end py-5 px-6 text-base font-semibold flex items-center justify-between"
                                    data-bs-toggle="collapse" data-bs-target="#collapseOne">
                                    <span class="flex-1">هزینه طراحی سایت چقدر است؟</span>
                                </button>
                            </div>
                            <div id="collapseOne" class="accordion-collapse collapse transition-all duration-300"
                                data-bs-parent="#accordionSimple">
                                <div class="card-body px-6 py-5">
                                    <p class="text-gray-600 leading-relaxed">هزینه طراحی سایت به عوامل مختلفی بستگی
                                        دارد. برای دریافت قیمت دقیق می‌توانید با ما تماس بگیرید.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse transition-all duration-300"
                                data-bs-parent="#accordionSimple">
                                <div class="card-body px-6 py-5">
                                    <p class="text-gray-600 leading-relaxed">زمان طراحی سایت بسته به نوع پروژه متفاوت
                                        است. معمولاً بین 2 تا 8 هفته زمان می‌برد.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div id="collapseThree" class="accordion-collapse collapse transition-all duration-300"
                                data-bs-parent="#accordionSimple">
                                <div class="card-body px-6 py-5">
                                    <p class="text-gray-600 leading-relaxed">بله، ما خدمات پشتیبانی و نگهداری سایت را به
                                        صورت ماهانه ارائه می‌دهیم.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        {{-- سوال 4 --}}
                        <div
                            class="card accordion-item bg-white hover:bg-gray-50 rounded-2xl shadow-sm transition-all duration-300 hover:-translate-y-1">
                            ...
                            <div id="collapseFour" class="accordion-collapse collapse transition-all duration-300"
                                data-bs-parent="#accordionSimple">
                                <div class="card-body px-6 py-5">
                                    <p class="text-gray-600 leading-relaxed">بله، تیم ما در زمینه طراحی اپلیکیشن‌های
                                        موبایل نیز تخصص دارد و می‌توانیم نیازهای شما را در این زمینه برآورده کنیم.</p>
                                </div>
                            </div>
                        </div>
                    </div>
