                        ...
                        <div class="pt-[390px] md:pt-[300px] xs:pt-[280px] pb-[205px] bg-no-repeat bg-center bg-cover relative z-[1] before:absolute before:-z-[1] before:inset-0 before:bg-edblue/70 before:pointer-events-none"
                            ...
                            <div class="mx-[10%] md:mx-[15px]">
                                <div class="text-white w-[48%] xl:w-[60%] md:w-[70%] sm:w-[80%] xs:w-full">
                                    <h2 class="font-bold text-[clamp(35px,4.57vw,80px)] leading-[1.13] mb-[15px]">{{$slider->title}}</h2>
                                    <p class="leading-[1.75] mb-[41px]">{{$slider->description}}</p>
                                    <div class="flex items-center gap-[20px]">
                                        <a href="{{$slider->link}}" class="ed-btn">{{trans('web/home.sliders.btn_show')}}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="mx-[19.71%] xxxl:mx-[14.71%] xxl:mx-[9.71%] xl:mx-[5.71%] md:mx-[12px]">
            <div class="flex md:flex-col items-start gap-y-[40px]">
                ...
                <div class="max-w-[50%] md:max-w-full">
                    <!-- heading -->
                    <div
                        class="pb-[40px] sm:pb-[20px] bg-[url('{{ asset('assets/web/img/testimonial-heading-vector.svg') }}')] bg-no-repeat bg-left-bottom bg-[length:1000px] mb-[40px]  md:bg-none md:mb-0">
                                ...
                                <div class="swiper-slide">
                                    <div>
                                        ...
                                        <p class="text-edgray mb-[24px]">Nullam dignissim ante scelerisque the is
                                            euismod fermentum odio sem semper the is erat a feugiat leo urna eget eros.
                                            Duis Aenean a imperdiet risus. Aliquam pellentesque.</p>
                                        <div>
                                            <h6 class="font-semibold text-[18px] text-edblue mb-[4px]">Ronald Richards
                                            </h6>
                ...
                <div>
                    <!-- heading -->
                    <div
                        class="pb-[40px] sm:pb-[20px] flex justify-end md:justify-start bg-[url('{{ asset('assets/web/img/testimonial-heading-vector.svg') }}')] bg-no-repeat bg-right-bottom bg-[length:1000px] mb-[40px] md:bg-none md:mb-0">
                        <div>
                        ...
                        <div
                            ...
                            <div>
                                <h5 class="font-semibold text-[20px] mb-[7px]"><a href="#"
                                        class="hover:text-edpurple">SAT Implementation Workshops November 2026</a></h5>
                                <h6 class="font-medium text-edpurple">11:00 - 13:30</h6>
                                <p class="border-t border-[#002147]/20 pt-[17px] mt-[10px]">There are many variations
            ...
            <div class="grid grid-cols-3 sm:grid-cols-2 xxs:grid-cols-1 gap-[30px] lg:gap-[20px]">
                ...
                <div class="ed-teacher group">
                    <div class="ed-teacher__img rounded-[16px] overflow-hidden">
                        <img src="{{ asset('assets/web/img/teacher-1.jpg') }}" alt="Team Member Image"
                    ...
                    <div
                        ...
                        <h5 class="font-semibold text-[20px] text-etBlack mb-[4px]"><a href="teacher-details.html"
                                class="hover:text-etBlue">Cameron Williamson</a></h5>
                ...
                <div class="ed-teacher group">
                    <div class="ed-teacher__img rounded-[16px] overflow-hidden">
                        <img src="{{ asset('assets/web/img/teacher-2.jpg') }}" alt="Team Member Image"
                            class="w-full aspect-[370/375] duration-[400ms] group-hover:scale-110">
                    </div>
                ...
                <div class="ed-teacher group">
                    <div class="ed-teacher__img rounded-[16px] overflow-hidden">
                        <img src="{{ asset('assets/web/img/teacher-3.jpg') }}" alt="Team Member Image"
                            class="w-full aspect-[370/375] duration-[400ms] group-hover:scale-110">
                    </div>
        ...
        <div class="mx-[19.71%] xxxl:mx-[14.71%] xxl:mx-[9.71%] xl:mx-[5.71%] md:mx-[12px]">
            ...
            <div
                ...
                <div
                    ...
                    <div class="ed-blog__img relative z-[1] mb-[45px]">
                        <div class="overflow-hidden rounded-[6px]">
                            <img src="{{ asset('assets/web/img/blog-1.png') }}" alt="blog image"
                    ...
                    <div class="et-blog__txt">
                        ...
                        <h4 class="et-blog__title text-[20px] sm:text-[18px] font-semibold leading-[1.6] mb-[20px]"><a
                                href="blog-details.html" class="hover:text-edpurple">Which Yoga Hybrid Is Right For
                                You?</a></h4>
                ...
                <div
                    ...
                    <div class="ed-blog__img relative z-[1] mb-[45px]">
                        <div class="overflow-hidden rounded-[6px]">
                            <img src="{{ asset('assets/web/img/blog-2.png') }}" alt="blog image"
                                class="w-full aspect-[37/24] object-cover transition duration-[400ms] group-hover:scale-105">
                        </div>
                ...
                <div
                    ...
                    <div class="ed-blog__img relative z-[1] mb-[45px]">
                        <div class="overflow-hidden rounded-[6px]">
                            <img src="{{ asset('assets/web/img/blog-3.png') }}" alt="blog image"
                                class="w-full aspect-[37/24] object-cover transition duration-[400ms] group-hover:scale-105">
                        </div>
            ...
            <div class="ed-partners-slider swiper mt-[100px] xl:mt-[70px] md:mt-[50px]">
                <div class="swiper-wrapper">
                    ...
                    <!-- single partner -->
                    <div class="swiper-slide"><img src="{{ asset('assets/web/img/partner-2.png') }}"
                            alt="Partner Logo" class="xxs:mx-auto"></div>
                    <!-- single partner -->
                    <div class="swiper-slide"><img src="{{ asset('assets/web/img/partner-3.png') }}"
                            alt="Partner Logo" class="xxs:mx-auto"></div>
                    <!-- single partner -->
                    <div class="swiper-slide"><img src="{{ asset('assets/web/img/partner-4.png') }}"
                            alt="Partner Logo" class="xxs:mx-auto"></div>
                    <!-- single partner -->
                    <div class="swiper-slide"><img src="{{ asset('assets/web/img/partner-5.png') }}"
                            alt="Partner Logo" class="xxs:mx-auto"></div>
                    <!-- single partner -->
                    <div class="swiper-slide"><img src="{{ asset('assets/web/img/partner-6.png') }}"
                            alt="Partner Logo" class="xxs:mx-auto"></div>
                    <!-- single partner -->
                    <div class="swiper-slide"><img src="{{ asset('assets/web/img/partner-1.png') }}"
                            alt="Partner Logo" class="xxs:mx-auto"></div>
