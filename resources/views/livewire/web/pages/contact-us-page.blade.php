        ...
        <div class="container pt-20 xl:pt-28 lg:pt-28 md:pt-28 pb-16 xl:pb-20 lg:pb-20 md:pb-20">
            <div class="flex flex-wrap mx-[-15px] !mt-[-50px] xl:mx-[-35px] lg:mx-[-20px] items-center">
                ...
                <div class="xl:w-5/12 lg:w-5/12 w-full flex-[0_0_auto] xl:!px-[35px] lg:!px-[20px] !px-[15px] max-w-full !mt-[50px]">
                    <span class="bg-[#fef4f2] text-[#f78b77] px-4 py-2 rounded-full text-sm font-medium inline-block mb-4">{{ trans('web/contact_us.hero_section.tag') }}</span>
                    ...
                    <div class="flex gap-4">
                        <a href="#contact-form" class="btn !text-white !bg-[#f78b77] border-[#f78b77] hover:text-white hover:bg-[#f67a63] hover:!border-[#f67a63] active:text-white active:bg-[#f78b77] active:border-[#f78b77] !rounded-[50rem] !mt-2 transition-all duration-300 hover:-translate-y-1">
                            {{ trans('web/contact_us.hero_section.contact_btn') }}
                        </a>
                        <a href="#contact-info" class="btn !text-[#f78b77] !bg-[#fef4f2] border-[#fef4f2] hover:!text-white hover:!bg-[#f78b77] hover:!border-[#f78b77] active:text-white active:bg-[#f78b77] active:border-[#f78b77] !rounded-[50rem] !mt-2 transition-all duration-300 hover:-translate-y-1">
    ...
    <section class="wrapper !bg-gradient-to-b from-[#fef4f2] to-[#fff8f6]">
        <div class="container py-[4.5rem] xl:!py-28 lg:!py-28 md:!py-28">
            <div class="flex flex-wrap mx-[-15px] xl:mx-[-35px] lg:mx-[-20px] !mt-[-50px] items-center">
                <div class="xl:w-6/12 lg:w-4/12 w-full flex-[0_0_auto] xl:!px-[35px] lg:!px-[20px] !px-[15px] max-w-full !mt-[50px]">
                    <div class="flex bg-white rounded-4xl flex-wrap">
                        <!-- آدرس -->
                        <a href="https://maps.google.com/?q={{ trans('web/contact_us.contact_info.office_address.value') }}" target="_blank" 
                           class="p-6 flex justify-center items-center transition-all hover:shadow-lg hover:bg-gray-50 hover:-translate-y-1 duration-300 flex-col w-1/2 border-e-1 border-b-1 border-gray-50 gap-y-2">
                            <div class="bg-[#3f78e0] rounded-full h-12 w-12 flex items-center justify-center hover:bg-[#2d5eb3] transition-colors duration-300">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="#fff" d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7m0 9.5a2.5 2.5 0 0 1 0-5a2.5 2.5 0 0 1 0 5"/></svg>
                            </div>
                            <p class="font-bold !m-0 text-lg">{{ trans('web/contact_us.contact_info.office_address.title') }}</p>
                            <p class="text-gray-600 text-center">{{ trans('web/contact_us.contact_info.office_address.value') }}</p>
                        </a>
                        ...
                        <a href="tel:{{ trans('web/contact_us.contact_info.phone.value') }}" 
                           class="p-6 flex justify-center items-center transition-all hover:shadow-lg hover:bg-gray-50 hover:-translate-y-1 duration-300 flex-col w-1/2 border-b-1 border-gray-50 gap-y-2">
                            <div class="bg-[#3f78e0] rounded-full h-12 w-12 flex items-center justify-center hover:bg-[#2d5eb3] transition-colors duration-300">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="#fff" d="M6.62 10.79c1.44 2.83 3.76 5.15 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24c1.12.37 2.33.57 3.57.57c.55 0 1 .45 1 1V20c0 .55-.45 1-1 1c-9.39 0-17-7.61-17-17c0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1c0 1.25.2 2.45.57 3.57c.11.35.03.74-.25 1.02z"/></svg>
                            </div>
                            <p class="font-bold !m-0 text-lg">{{ trans('web/contact_us.contact_info.phone.title') }}</p>
                            <p class="text-gray-600 text-center" dir="ltr">{{ trans('web/contact_us.contact_info.phone.value') }}</p>
                        </a>

                        <!-- تلگرام -->
                        <a href="https://t.me/{{ trans('web/contact_us.contact_info.telegram.value') }}" target="_blank" 
                           class="p-6 flex justify-center items-center transition-all hover:shadow-lg hover:bg-gray-50 hover:-translate-y-1 duration-300 flex-col w-1/2 border-e-1 gap-y-2">
                            <div class="bg-[#3f78e0] rounded-full h-12 w-12 flex items-center justify-center hover:bg-[#2d5eb3] transition-colors duration-300">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="#fff" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10s10-4.48 10-10S17.52 2 12 2m4.64 6.8c-.15 1.58-.8 5.42-1.13 7.19c-.14.75-.42 1-.68 1.03c-.58.05-1.02-.38-1.58-.75c-.88-.58-1.38-.94-2.23-1.5c-.99-.65-.35-1.01.22-1.59c.15-.15 2.71-2.48 2.76-2.69a.2.2 0 0 0-.05-.18c-.06-.05-.14-.03-.21-.02c-.09.02-1.49.95-4.22 2.79c-.4.27-.76.41-1.08.4c-.36-.01-1.04-.2-1.55-.37c-.63-.2-1.12-.31-1.08-.66c.02-.18.27-.36.74-.55c2.92-1.27 4.86-2.11 5.83-2.51c2.78-1.16 3.35-1.36 3.73-1.36c.08 0 .27.02.39.12c.1.08.13.19.14.27c-.01.06.01.24 0 .24"/></svg>
                            </div>
                            <p class="font-bold !m-0 text-lg">{{ trans('web/contact_us.contact_info.telegram.title') }}</p>
                            <p class="text-[#3f78e0]">{{ trans('web/contact_us.contact_info.telegram.value') }}</p>
                        </a>

                        <!-- اینستاگرام -->
                        <a href="https://www.instagram.com/{{ trans('web/contact_us.contact_info.instagram.value') }}" target="_blank" 
                           class="p-6 flex justify-center items-center transition-all hover:shadow-lg hover:bg-gray-50 hover:-translate-y-1 duration-300 flex-col w-1/2 gap-y-2">
                            ...
                            <p class="font-bold !m-0 text-lg">{{ trans('web/contact_us.contact_info.instagram.title') }}</p>
