<div>
    ...
    style="background-image: url('/assets/web/img/breadcrumb-bg.jpg')">
        ...
        <div class="vectors">
            <img src="/assets/web/img/breadcrumb-vector-1.svg" alt="vector" class="absolute -z-[1] pointer-events-none bottom-[34px] left-0 xl:left-auto xl:right-[90%]">
            <img src="/assets/web/img/breadcrumb-vector-2.svg" alt="vector" class="absolute -z-[1] pointer-events-none bottom-0 right-0 xl:right-auto xl:left-[60%]">
        </div>
    </section>
        ...
        <div class="mx-[19.71%] xxxl:mx-[14.71%] xxl:mx-[9.71%] xl:mx-[5.71%] md:mx-[12px]">
            <div class="flex sm:flex-col items-start justify-between gap-[15px]">
                ...
                <div class="max-w-[50%] sm:max-w-full mb-[60px]">
                    ...
                    <a href="#" class="font-medium text-edpurple inline-flex items-center gap-[10px] border-b border-edpurple">Overview <span class="icon"><img src="/assets/web/img/icon/arrow-up-right.svg" alt="icon"></span></a>
                </div>
            </div>

            <div class="flex items-center">
                <div class="md:w-[10%] xxs:w-[5%]">
                    <img src="/assets/web/img/about-inner-img.jpg" alt="About image" class="w-[633px] max-w-[633px] sm:max-w-[308px] aspect-[633/431px]">
                </div>

                <div class="md:w-[90%] xxs:w-[95%]">
                    <div class="bg-white p-[50px] lg:p-[30px] xxs:p-[20px] shadow-[0_4px_25px_rgba(0,0,0,0.06)] -ms-[92px] xl:-ms-[134px] lg:-ms-[278px] md:ms-0">
                        <h6 class="font-semibold uppercase text-edpurple relative z-[1] ps-[40px] mb-[10px] before:absolute before:left-0 before:top-[50%] before:-translate-y-[50%] before:h-[1px] before:w-[30px] before:bg-edpurple">About Edutics</h6>
                        <h4 class="font-semibold text-[30px] md:text-[26px] xs:text-[22px] leading-[1.2] mb-[26px]">WE SUPPORT YOUR AMBITION</h4>
                        <ul class="ed-inner-about-list font-medium text-[16px] text-edgray grid grid-cols-[repeat(2,max-content)] xs:grid-cols-1 gap-x-[30px] xxs:gap-x-[15px] gap-y-[9px] mb-[37px] *:ps-[25px] *:relative *:before:absolute *:before:left-0 *:before:top-[4px] *:before:w-[15px] *:before:aspect-square *:before:bg-[url(/assets/web/img/icon/checkmark.svg)] *:before:bg-no-repeat *:before:bg-[length:15px_13px] *:before:bg-center">
                        ...
                        <div class="flex flex-wrap items-center gap-x-[24px] gap-y-[20px]">
                            <div class="flex gap-x-[8px]">
                                <div class="rounded-full overflow-hidden w-[58px] aspect-square shrink-0">
                                    <img src="/assets/web/img/user.png" alt="Principal" class="w-[58px] aspect-square">
                                </div>
                                <div>
    ...
    <section class="bg-[#FAF9F6] relative z-[1] overflow-hidden">
        <div class="flex lg:flex-col items-end gap-[130px] xxxl:gap-[100px] xxl:gap-[60px] lg:gap-y-0 ms-[19.5%] xxxl:ms-[14.71%] xxl:ms-[9.71%] xl:ms-[5.71%] lg:mx-[5.71%] md:mx-[12px]">
            <!-- left / text -->
            <div class="py-[120px] xl:py-[80px] md:py-[60px]">
                ...
                <h6 class="font-semibold text-[18px] text-[#002147] mb-[23px] relative ps-[30px] before:absolute before:bg-edyellow before:w-[20px] before:h-[2px] before:left-0 before:top-[50%] before:-translate-y-[50%]">We provide the best success opportunities</h6>
                <ul class="ed-inner-about-list font-medium text-[16px] text-black grid grid-cols-2 xxs:grid-cols-1 gap-x-[30px] xxs:gap-x-[15px] gap-y-[9px] mb-[46px] *:ps-[25px] *:relative *:before:absolute *:before:left-0 *:before:top-[4px] *:before:w-[15px] *:before:aspect-square *:before:bg-[url(/assets/web/img/icon/checkmark.svg)] *:before:bg-no-repeat *:before:bg-[length:15px_13px] *:before:bg-center">
            ...
            <div class="relative shrink-0 xxxl:max-w-[55%] lg:max-w-full">
                <img src="/assets/web/img/employability-img.jpg" alt="image" class="min-h-[280px]">
        ...
        <!-- vector -->
        <img src="/assets/web/img/employability-vector.svg" alt="vector" class="absolute -z-[1] bottom-[186px] left-[37px] pointer-events-none">
    </section>
            ...
            <div class="ed-program-slider swiper">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <!-- img -->
                        <div class="mb-[30px]">
                            <img src="/assets/web/img/program-1.jpg" alt="image">
                        </div>
                    ...
                    <div class="swiper-slide">
                        <!-- img -->
                        <div class="mb-[30px]">
                            <img src="/assets/web/img/program-2.jpg" alt="image">
                        </div>
                    ...
                    <div class="swiper-slide">
                        <!-- img -->
                        <div class="mb-[30px]">
                            <img src="/assets/web/img/program-3.jpg" alt="image">
                        </div>
    ...
    <section class="bg-edpurple relative z-[1] overflow-hidden">
        <div class="mx-[19.71%] xxxl:mx-[14.71%] xxl:mx-[9.71%] xl:mx-[5.71%] md:mx-[12px]">
            <div class="flex md:flex-col items-center gap-[60px] lg:gap-[40px] md:gap-y-[20px]">
                ...
                <div class="shrink-0 relative z-[1] pe-[40px] lg:pe-0">
                    <img src="/assets/web/img/cta-img.png" alt="image">
                    <img src="/assets/web/img/cta-img-vector.svg" alt="vector" class="absolute right-[0] lg:right-[-40px] top-[20px] -z-[1] max-w-[460px]">
                </div>
            </div>
        </div>
        ...
        <!-- vector -->
        <div>
            <img src="/assets/web/img/cta-vector-1.png" alt="vector" class="absolute -z-[1] bottom-0 left-0 pointer-events-none">
            <img src="/assets/web/img/cta-vector-2.png" alt="vector" class="absolute -z-[1] top-0 right-0 pointer-events-none">
        </div>
    </section>
    <!-- CTA SECTION END -->
