        ...
        <div class="col-span-2 grid grid-cols-1 gap-4">
            <x-card :title="trans('general.page_sections.data')" shadow separator progress-indicator="submit">
                <div class="grid grid-cols-1 gap-4">
                    ...
                    <x-select :label="trans('validation.attributes.size')" wire:model.live="size" :options="\App\Enums\BannerSizeEnum::formatedCases()" option-label="label"
        ...
        <div class="col-span-1 ">
            <div class="sticky top-20">
                <x-card :title="trans('general.page_sections.upload_image')" shadow separator progress-indicator="submit" class="">
                    <x-admin.shared.single-file-upload wire_model="image" :default_image="$model->getFirstMediaUrl('image', $model->getPrimaryResolution())" :crop_after_change="true"
                        :ratio="$ratio" />
                </x-card>
