<div class="">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        @foreach($roles as $role)
            <div class="bg-white rounded-xl border border-gray-200 p-6 shadow-sm flex flex-col justify-center min-h-[300px] w-full">
        ...
        <div wire:click="edit"
            ...
            <!-- Illustration Image -->
            <img src="{{ asset('assets/img/role_create.png') }}" alt="Add Role"
