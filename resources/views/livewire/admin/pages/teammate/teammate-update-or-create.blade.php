            ...
            <x-card :title="trans('general.page_sections.data')" shadow separator progress-indicator="submit">
                <div class="grid grid-cols-1 gap-4">
                    ...
                    <x-textarea :label="trans('validation.attributes.description')"
                                ...
                                required
                    />
                    <x-textarea :label="trans('validation.attributes.bio')"
                                wire:model="bio"
                    />
                    <x-input :label="trans('validation.attributes.position')"
                             wire:model="position"
                             required
                    />
                    <x-input :label="trans('validation.attributes.email')"
                             wire:model="email"
                    />
                    <x-datetime :label="trans('validation.attributes.birthday')"
                                wire:model="birthday"
                                required
                    />
                </div>
