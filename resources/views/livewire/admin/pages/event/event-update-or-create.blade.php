        ...
        <div class="grid grid-cols-1 col-span-2 gap-4">
            <x-card :title="trans('general.page_sections.data')" shadow separator progress-indicator="submit">
                <div class="grid grid-cols-1 gap-4">
                    ...
                    <x-input :label="trans('validation.attributes.description')" wire:model.blur="description"
                             required/>
                    <x-admin.shared.tinymce wire:model.blur="body"/>
                    <x-input :label="trans('validation.attributes.location')" wire:model.blur="location" required/>
        ...
        <div class="col-span-1">
            <div class="sticky top-16">
                ...
                <x-card :title="trans('general.page_sections.publish_config')" shadow separator
                    ...
                    <x-input :label="trans('validation.attributes.capacity')" wire:model.blur="capacity" required/>
                </x-card>
            </div>
        </div>
