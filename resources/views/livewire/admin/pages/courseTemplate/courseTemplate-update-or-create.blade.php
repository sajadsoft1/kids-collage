                        ...
                        <x-slot:heading>
                            <div class="p-5">
                                <div class="flex items-center space-x-3 mb-5">
                                    <div class="flex w-12 h-12 bg-primary text-white rounded-full text-center text-2xl justify-center items-center">{{$session['order']}}</div>
                                    <div class="grow">
                                ...
                                <div class="flex justify-between items-center">
                                    <div class="grow flex space-x-5">
                                        <div class="inline-flex items-center text-sm font-medium text-slate-600 hover:text-slate-700">
                                            <span>
                                                <x-input
                                                        icon="lucide.timer"
