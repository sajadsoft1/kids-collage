                ...
                <div class="col-span-1">
                    <div class="sticky top-16">
                        <x-card :title="trans('general.page_sections.publish_config')" shadow separator progress-indicator="submit">
                            <div class="grid grid-cols-1 gap-4">
                                <x-admin.shared.smart-datetime :label="trans('validation.attributes.start_date')" wire:model="starts_at" required/>
                                <x-admin.shared.smart-datetime :label="trans('validation.attributes.end_date')" wire:model="ends_at" required/>
