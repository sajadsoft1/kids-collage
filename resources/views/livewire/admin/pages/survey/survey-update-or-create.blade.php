    ...
    <x-tabs wire:model="selectedTab" active-class="bg-primary rounded !text-white" label-class="font-semibold"
                ...
                <div class="col-span-1">
                    <div class="sticky top-16">
                        <x-card :title="trans('general.page_sections.publish_config')" shadow separator progress-indicator="submit">
                            <div class="grid grid-cols-1 gap-4">
                                <x-datetime :label="trans('validation.attributes.start_date')" wire:model="starts_at" required />
                                <x-datetime :label="trans('validation.attributes.end_date')" wire:model="ends_at" required />
                ...
                <x-card title="سوالات نظر سنجی" shadow separator>
                    <div class="space-y-4">
                        <div class="flex items-center justify-between">
                            <p class="text-sm text-content-muted">ایجاد سوالات نظر سنجی (این سوالات در بانک سوالات نمایش
                                داده نمی‌شوند)</p>
                        ...
                        @if (empty($questions))
                            <div class="py-8 text-center text-base-content/60">
                                ...
                                <p class="mt-2 text-sm">برای شروع، یک سوال اضافه کنید.</p>
                            </div>
                        @endif
                    </div>
                </x-card>
        ...
        <x-tab name="rules" label="قوانین شرکت" icon="o-shield-check">
            <div wire:key="rules-tab-wrapper">
                <x-card title="قوانین شرکت در نظر سنجی" shadow separator>
