<div
    ...
    <!-- Mobile menu button -->
    <button type="button" class="-m-2.5 p-2.5 text-gray-700 lg:hidden" x-data
        x-on:click="$dispatch('toggle-drawer', { id: 'main-drawer' })">
    ...
    <button type="button" class="hidden lg:flex -m-2.5 p-2.5 text-gray-700" x-data
