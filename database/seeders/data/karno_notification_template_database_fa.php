        ...
        [
            ...
            'data' => [
                'fa' => [
                    'subject' => null,
                    'title' => 'تیکت جدید',
                    'subtitle' => 'تیکت شما با موفقیت ثبت شد',
                    'body' => 'سلام {{user_name}} عزیز، تیکت شما با شماره {{ticket_number}} با موفقیت ثبت شد. موضوع: {{ticket_subject}}',
                    'cta' => [
                        'label' => 'مشاهده تیکت',
                        'url' => '{{action_url}}',
                    ],
        ...
        [
            ...
            'data' => [
                'fa' => [
                    'subject' => null,
                    'title' => 'پاسخ به تیکت',
                    'subtitle' => 'پاسخ جدید به تیکت شما',
                    'body' => 'سلام {{user_name}} عزیز، پاسخ جدیدی به تیکت شما با شماره {{ticket_number}} ارسال شده است.',
                    'cta' => [
                        'label' => 'مشاهده پاسخ',
                        'url' => '{{action_url}}',
                    ],
        ...
        [
            ...
            'data' => [
                'fa' => [
                    'subject' => null,
                    'title' => 'حل تیکت',
                    'subtitle' => 'تیکت شما حل شد',
                    'body' => 'سلام {{user_name}} عزیز، تیکت شما با شماره {{ticket_number}} حل شد. در صورت نیاز به کمک بیشتر، می‌توانید تیکت جدیدی ایجاد کنید.',
                    'cta' => [
                        'label' => 'مشاهده تیکت',
                        'url' => '{{action_url}}',
                    ],
